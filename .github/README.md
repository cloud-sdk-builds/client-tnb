...
[`@aws-sdk/client-tnb`](https://www.npmjs.com/package/@aws-sdk/client-tnb/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQbK1Y29Gi4rKkva4nHqTAfVAbdUIg+LDK1A7f0EqwPvOSpl1xadVmyO4gYrk/6S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-tnb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.888.0/index.min.mjs": "sha384-yQbK1Y29Gi4rKkva4nHqTAfVAbdUIg+LDK1A7f0EqwPvOSpl1xadVmyO4gYrk/6S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-tnb/blob/refs/tags/3.888.0/LICENSE
```
