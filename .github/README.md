...
[`@aws-sdk/client-tnb`](https://www.npmjs.com/package/@aws-sdk/client-tnb/v/3.1056.0).
...
- @aws-sdk/client-tnb v3.1056.0 - [https://cloud-sdk-builds.github.io/?sdk=client-tnb&version=3.1056.0](https://cloud-sdk-builds.github.io/?sdk=client-tnb&version=3.1056.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.1056.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ypeUrUQNrEHIGlBIWQ8FAy6QV+pZIDvyDiwyDFV3rhJ5K+EO6BtfWq/Z08UUg8on
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-tnb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.1056.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.1056.0/index.min.mjs": "sha384-ypeUrUQNrEHIGlBIWQ8FAy6QV+pZIDvyDiwyDFV3rhJ5K+EO6BtfWq/Z08UUg8on"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-tnb";
...
```
https://github.com/cloud-sdk-builds/client-tnb/blob/refs/tags/3.1056.0/LICENSE
```
