...
[`@aws-sdk/client-tnb`](https://www.npmjs.com/package/@aws-sdk/client-tnb/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GnSQX3lHMeJRA+IjCrZ4BKfGzLjx3St+6YDMq+UyU4r0gyNFbUYytp+LLrSnCQMk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-tnb": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-tnb@3.863.0/index.min.mjs": "sha384-GnSQX3lHMeJRA+IjCrZ4BKfGzLjx3St+6YDMq+UyU4r0gyNFbUYytp+LLrSnCQMk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-tnb/blob/refs/tags/3.863.0/LICENSE
```
